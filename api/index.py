...
app = FastAPI(
    ...
    description="REST API containing all 30 NBA teams with full 2026-2027 rosters and player stats.",
    version="1.0.0"
)
...
teams = [
    # Eastern Conference - Atlantic
    {
        ...
        "description": "High-powered Eastern powerhouse with lockdown perimeter defense and 3-point volume.",
        "roster": [
    ...
    },
    {
        ...
        "founded": 1970, "championships": 1, "arena": "Rocket Arena",
    ...
    {
        "id": 22, "name": "Los Angeles Clippers", "city": "Los Angeles", "conference": "Western", "division": "Pacific",
    ...
    },
    {
        ...
        "description": "Athletic, dynamic roster structured around Zion Williamson's unstoppable paint paint attacks.",
        "roster": [
